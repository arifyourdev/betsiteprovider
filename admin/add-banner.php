...
if(is_post_request()){
 ...
 $shor_title = htmlentities($database->escape_string($_POST['banner']['shor_title']));
  ...
  if(is_uploaded_file($_FILES['banner_image']['tmp_name'])){
    ...
    $banner->errors[] = "Please upload a Banner Image or link with an existing banner.";
    $result = false;
  }
 ...
 if($result === true)
    ...
    if($linked_banner) {
        ...
        Banner::set_group($banner->id, $banner->id);
    }
    $session->message('The Banner was created successfully.');
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                ...
                                <form class="needs-validation" method="post" enctype="multipart/form-data">
                                    ...
                                    <a href="banners/<?php echo $language?>" class="btn btn-secondary">Cancel</a>
                                </form>
                            </div>
                        </div>
                        </div>
