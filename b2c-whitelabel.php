...
$products = Product::find_by_web_type('b2c-whitelabel', $product_language);
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
  <title> <?php echo $b2c_meta_title ?> </title>
  <meta charset="UTF-8">
...
<body>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="sub-inner-content-con d-flexs align-items-center justify-content-between">
              <div class="sub-banner-left-con">
                <h1 class="text-white"><?php echo $b2c_meta_title ?></h1>
              ...
              <div class="breadcrumb-con d-inline-block">
                <ol class="breadcrumb mb-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"><?php echo $b2c_meta_title ?></li>
                </ol>
              </div>
  ...
  <!-- B2C WHITELABEL PRODUCTS SECTION -->
  <section
    ...
    <div class="container wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
      <div class="heading-title-con text-center">
        <span class="special-text green-text d-block"><?=  $b2c_sub_title  ?></span>
        <h2 class="text-white"><?=  $b2c_meta_description ?></h2>
        <!-- heading title con -->
      </div>
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 d-flex">
          <div class="game-box w-100 position-relative">
            ...
            <div class="game-details position-absolute">
              ...
              <a href="#" class="d-inline-block green-text mr-3" data-toggle="modal" data-target="#productModal<?php echo $product->id ?>"> <?php echo $read_more ?><i class="fa-solid fa-angle-right"></i></a>
